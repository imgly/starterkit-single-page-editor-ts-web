/**
 * Single Page Editor Plugin - Design Editor Configuration with Single-Page Mode
 *
 * This plugin provides a design editor configuration optimized for single-page
 * designs like social media posts, business cards, or fixed-format graphics.
 *
 * @example Basic usage
 * ```typescript
 * import CreativeEditorSDK from '@cesdk/cesdk-js';
 * import { SinglePageEditorConfig } from './plugin';
 *
...
/**
 * Single Page Editor configuration plugin.
 *
 * Provides a design editing experience optimized for single-page designs
 * like social media posts, business cards, or fixed single-page graphics.
 *
 * @public
 */
export class SinglePageEditorConfig implements EditorPlugin {
  /**
   * Unique identifier for this plugin.
   * Used to identify the plugin in the CE.SDK plugin registry.
   */
  name = 'cesdk-single-page-editor';
